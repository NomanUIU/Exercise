...
public class BankInfoActivity extends Activity {
   public final static String EXTRA_MESSAGE = "com.noman.bankinfo.MESSAGE";
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      ArrayList array_list = mydb.getAllBankList();
     ...
     long arg3) {
         ...
         Intent intent = new Intent(getApplicationContext(),com.noman.bankinfo.DisplayBankList.class);
